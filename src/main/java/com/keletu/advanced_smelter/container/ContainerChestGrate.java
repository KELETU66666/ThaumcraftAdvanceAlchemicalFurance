package com.keletu.advanced_smelter.container;
...
public class ContainerChestGrate extends Container
{
    ...
    public ContainerChestGrate(InventoryPlayer playerInventory, IInventory hopperInventoryIn, EntityPlayer player)
    {
