package com.keletu.ancient_thaumcraft.client;
...
import static thaumcraft.client.lib.UtilsFX.VERTEXFORMAT_POS_TEX_CO_LM_NO;

@SideOnly(value= Side.CLIENT)
public class TileAlchemyFurnaceAdvancedRendererTEST
extends TileEntitySpecialRenderer<TileAlchemyFurnaceAdvanced> {
    ...
    public static void renderQuadFromIcon(IBlockState state, int brightness, float width) {
    ...
    //public void renderQuadCenteredFromIcon(IBlockState state, float width) {
    //    Minecraft mc = Minecraft.getMinecraft();
    //    BlockRendererDispatcher dispatcher = mc.getBlockRendererDispatcher();
    //    BlockModelShapes shapes = dispatcher.getBlockModelShapes();
    //    IBakedModel thisBlock = shapes.getModelForState(state);
